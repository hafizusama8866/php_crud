        ...
        if (strlen($name) <= 10) {
            if (strlen($fname) <= 10) {
                if (move_uploaded_file($tmp_name, $folder)) {
                    $sql = "INSERT INTO c_table (name,fname,phone,dropdown,email,address,gender,file) 
                     VALUES('" . $name . "','" . $fname . "','" . $phone . "','" . $dropdown . "','" . $email . "','" . $address . "','" . $gender . "','" . $file . "')";
            ...
            $name_size_error = "Name should have less then 10 character";
        }
    }
}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= isset($address_error) ? 'red_border' : '' ?>" id="address"
                                rows="3" name="address" placeholder="Enter your address"></textarea>
